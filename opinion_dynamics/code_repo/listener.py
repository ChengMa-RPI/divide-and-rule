...
"""
"plot x_A and x_B"
plt.plot(np.arange(t), x_evolution[:, 0], '#66c2a5', linestyle='-', linewidth=2, alpha = 0.8, label='$x_{A}$ - Recursive')
plt.plot(tstep, result2[:, 0], '#fc8d62', linestyle='-.', linewidth=2, alpha = 0.8, label='$x_{A}$ - ODEs')
plt.plot(np.arange(t), x_evolution[:, 1], '#8da0cb', linestyle='-', linewidth=2, alpha = 0.8, label='$x_{B}$ - Recursive')
plt.plot(tstep, result2[:, 1], '#e78ac3', linestyle='-.', linewidth=2, alpha = 0.8, label='$x_{B}$ - ODEs')
plt.ylabel('$x$', fontsize=fontsize)
plt.xlabel('t', fontsize=fontsize)
plt.xticks(fontsize=ticksize)
plt.yticks(fontsize=ticksize)
